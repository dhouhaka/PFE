...
class _LoginScreenState extends State<LoginScreen>
  ...
  Future<void> _handleSubmit() async {
    ...
    try {
      ...
      // TODO: Save token, navigate based on role
      ...
      body: Stack(
        children: [
          ...
          _AnimatedBlob(
            ...
            colors: const [
              Color(0x4D7C3AED), // purple-600/30
              Color(0x4D2563EB), // blue-600/30
              Color(0x4D0891B2), // cyan-600/30
            ],
          ),
          _AnimatedBlob(
            ...
            alignment: const Alignment(0.5, 0.5),
            colors: const [
              Color(0x4DDC2626), // pink
              Color(0x4D7C3AED), // purple
              Color(0x4D2563EB), // blue
            ],
          ),
          _AnimatedBlob(
        ...
        child: Container(
          decoration: const BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: [
                Color(0x1A7C3AED), // purple/10
                Colors.transparent,
                Color(0x1A0891B2), // cyan/10
              ],
            ),
          ),
          child: Padding(
...
class _Alert extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final iconColor =
        isError ? const Color(0xFFF87171) : const Color(0xFF4ADE80);
    final textColor =
